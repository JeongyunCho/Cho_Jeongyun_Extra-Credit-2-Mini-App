...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 16, 2018 at 04:19 AM
...
(1, 'F56', 'Mini Cooper F56', '37,790', 'The MINI 5 door boasts the same iconic good looks as its 3 door brother, but features an extra pair of passenger doors for practical access to its and feel more refined than its predecessor, the open-air exhilaration that awaits you behind the wheel remains the same. We can’t wait for you to experience it in person. Until then... stay open.', 'F56.jpg'),
...
(2, 'F56', 'mini_2.mp4', 'vid2.jpg'),
(3, 'F58', 'mini_3.mp4', 'vid3.jpg');
COMMIT;
